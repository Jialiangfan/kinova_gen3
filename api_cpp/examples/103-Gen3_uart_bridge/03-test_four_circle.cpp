...
void example_twist_circle(const std::string& ip_address) 
{
    // 错误回调
    ...
    create_session_info.set_session_inactivity_timeout(60000);   // (毫秒)
    create_session_info.set_connection_inactivity_timeout(2000); // (毫秒)
...
int main() 
{
    ...
    {
        threads.emplace_back(example_twist_circle, ip);
    }
